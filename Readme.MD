...
**From Operations to AI/ML Engineering** 
– I bring a unique perspective to machine learning: I understand **efficiency** (from 6 years in supply chain operations), **business impact** (from analytics work), and **production deployment** (from recent deep ML engineering).
...
- **2024-2025**: Data Analytics, Deep dive into production ML systems (M2M Tech -Internship AI project), Building AI agents, researching model architectures
...
**🎓 Formal Training:** 
- University of Toronto (ML & Data Science Certification, 2025)
- Stanford University (ML Specialization, 2024)
- University of Windsor (M.A.Sc. Electrical Engineering, 2012)
- Anna University (B.E. Electronics & Communication, 2008)
...
**Deep Dive into Sequence Models | Dec 2025 - Feb 2026**
...
**Google 5-Day AI Intensive Capstone | Nov 2025**
...
### 🏫 Formal Degrees
- 🎓 **University of Windsor** (2010-2012) - M.A.Sc. Electrical Engineering (Signal Processing, Control Systems)
- 🎓 **Anna University** (2004-2008) - B.E. Electronics & Communication Engineering

### 📚 ML/AI Certifications (2024-2025)
